...
export default function EditProductPage() {
  ...
  useEffect(() => {
    fetch('/api/admin/products')
      .then(r => r.json())
      .then((products: { id: string; name?: string; slug?: string; category?: string; price?: number; image?: string; description?: string; details?: string[]; maker?: string; isNew?: boolean; stock?: number }[]) => {
